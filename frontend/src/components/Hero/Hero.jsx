...
{/* the best ad */}
          ...
          <div className='hero-text'>
            <div>
              <span >Gym</span>
              <span className='stroke-text' style={{'-webkit-text-stroke-width': '2px'
}}>Fluencer</span>
            </div>
            <div>
              <br/>
              {/* <span style={{fontSize:'59px'}}>No Pain No Gain</span> */}
            </div>
            <div>
              <span>
      ...
      <div className='right-h'>
        ...
        {/** hero imagenes */}
          {/* <img src={ Hero_image } alt=''  width={10} className='hero-image' /> */}
          <motion.img
          initial = {{right: '10rem'}}
